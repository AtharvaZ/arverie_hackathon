...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    const sortedLeaves = [...leafPaths].sort(
      (a, b) => getPathX(b) - getPathX(a),
    ); // R→L
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  pointerEvents: "none",
                  background:
                    "linear-gradient(110deg, transparent 15%, rgba(255,255,255,0.38) 50%, transparent 85%)",
