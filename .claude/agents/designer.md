...
**IMPORTANT: All frontend work must be scoped to the `frontend/` directory only. Do not touch any files outside of `frontend/`.**

Read `.claude/agents/designer/SKILL.md` for full instructions, design rules, and data search usage before starting any work.
